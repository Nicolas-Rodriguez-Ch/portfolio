export const initialProjects = [
  {
    id: 0,
    title: 'TechnoTrove Server Go',
    deployLink: 'https://technotrovego.onrender.com/api/healthcheck',
    summary:
      'TechnoTrove Server Go is a practice web sever in oder for me to familarize myself with Go language. The Technotrove Server is responsible for managing user profiles, project creation, and image uploading. It provides an infrastructure for user creation with password encryption, user authentication using JWT, and project management linked to user profiles',
    description:
      'The Technotrove Server in Golang is responsible for managing user profiles, project creation, and image uploading. It provides an infrastructure for user creation with password encryption, user authentication using JWT, and project management linked to user profiles',
    image:
      'https://res.cloudinary.com/dhyu9pxjh/image/upload/v1740778362/Captura_de_pantalla_2025-02-28_163208_broxi3.png',
    repos: [
      {
        name: 'Techno Trove Server Go',
        value: 'https://github.com/Nicolas-Rodriguez-Ch/technoTroveGo',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    `,
    image:
      'https://res.cloudinary.com/dhyu9pxjh/image/upload/v1689700669/image_zis4ec.png',
    repos: [
      {
